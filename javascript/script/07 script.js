function CalcularDiaSiguiente() {
	...
	// Comprobar los casos en que el dia es el ultimo del mes
	if ( (diaActual == 30) && ( (mesActual == 4) || (mesActual == 6) || (mesActual == 9) || (mesActual == 11) ) )
	{
		diaActual = 1;
		mesActual = mesActual + 1;
	}
	else
	if ( (diaActual == 31) && ( (mesActual == 1)  || (mesActual == 3) || (mesActual == 5) || (mesActual == 7)|| 
